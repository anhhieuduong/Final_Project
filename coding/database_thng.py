...
engine = create_engine(
    "sqlite:///thngdb.db", connect_args={"check_same_thread": False}
)
...
if __name__ == "__main__":
    ...
    df_artists = 'data/thng/df_artists_thng.csv'
    ...
    df_audio_features = 'data/thng/df_audio_features_thng.csv'
    ...
    df_tracks = 'data/thng/df_tracks_thng.csv'
